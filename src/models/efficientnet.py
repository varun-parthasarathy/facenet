...
def efficientnet_params(model_name):
  ...
  params_dict = {
      ...
      'efficientnet-a0': (2.0, 2.2, 224, 0.2),
  }
...
def build_model(images,
  ...
  logits = tf.identity(logits, 'prelogits')
...
def inference(image_batch, keep_prob, bottleneck_layer_size, phase_train, weight_decay=0.0, model='a0'):
  global EMBEDDING_SIZE
  EMBEDDING_SIZE = bottleneck_layer_size

  return build_model(image_batch, model_name='efficientnet-'+model, training=phase_train)
